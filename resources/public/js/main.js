...
var melodicorn = {util:{}};
melodicorn.util.map_with_accumulator = function map_with_accumulator(b, c, d) {
  if (cljs.core.empty_QMARK_.call(null, d)) {
    return null;
  }
  var e = b.call(null, cljs.core.first.call(null, d), c);
  c = cljs.core.nth.call(null, e, 0, null);
  e = cljs.core.nth.call(null, e, 1, null);
  return cljs.core.cons.call(null, c, map_with_accumulator.call(null, b, e, cljs.core.rest.call(null, d)));
};
melodicorn.util.acc_apply = function(a, b, c) {
  return cljs.core.into.call(null, a, new cljs.core.PersistentArrayMap.fromArray([b, c.call(null, b.call(null, a))], !0, !1));
};
melodicorn.util.inc_2 = function(a) {
  return 2 + a;
};
melodicorn.util.entity_type = cljs.core.first;
melodicorn.util.third = function(a) {
  return cljs.core.get.call(null, a, 2);
};
melodicorn.util.fourth = function(a) {
  return cljs.core.get.call(null, a, 3);
};
goog.userAgent = {};
...
melodicorn.music_theory.modes = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "major", "major", 1117563179), melodicorn.music_theory.major_scale], null);
melodicorn.music_theory.diatonic_pitch_classes = cljs.core.set.call(null, cljs.core.range.call(null, melodicorn.music_theory.scale_length));
melodicorn.music_theory.accidentals = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null, "natural", "natural", 2742815643), null, new cljs.core.Keyword(null, "flat", "flat", 1017049835), null, new cljs.core.Keyword(null, "sharp", "sharp", 1123304284), null, new cljs.core.Keyword(null, "double-sharp", "double-sharp", 971240032), null, new cljs.core.Keyword(null, "no-accidental", "no-accidental", 2955605368), null, new cljs.core.Keyword(null, 
"double-flat", "double-flat", 3644543847), null], null), null);
...
melodicorn.music_theory.apply_accidental = function(a, b) {
  if (!cljs.core.truth_(a.call(null, melodicorn.music_theory.accidentals))) {
    throw Error("Assert failed: " + cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null, cljs.core.list(new cljs.core.Symbol(null, "accidental", "accidental", 325881907, null), new cljs.core.Symbol(null, "accidentals", "accidentals", -811257102, null)))));
  }
  return a.call(null, new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null, "double-flat", "double-flat", 3644543847), function(a) {
    return a - 2;
  }, new cljs.core.Keyword(null, "flat", "flat", 1017049835), cljs.core.dec, new cljs.core.Keyword(null, "no-accidental", "no-accidental", 2955605368), cljs.core.identity, new cljs.core.Keyword(null, "sharp", "sharp", 1123304284), cljs.core.inc, new cljs.core.Keyword(null, "double-sharp", "double-sharp", 971240032), function(a) {
    return a + 2;
  }], null)).call(null, b);
};
...
melodicorn.music_theory.key_accidentals = function(a, b) {
  if (!cljs.core.truth_(b.call(null, melodicorn.music_theory.accidentals))) {
    throw Error("Assert failed: " + cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null, cljs.core.list(new cljs.core.Symbol(null, "accidental", "accidental", 325881907, null), new cljs.core.Symbol(null, "accidentals", "accidentals", -811257102, null)))));
  }
  var c = cljs.core.drop.call(null, a, melodicorn.music_theory.major_scale_chromatic_degrees), d = cljs.core.partition.call(null, 2, 1, c), e = cljs.core.map.call(null, function(a, b) {
    return function(a) {
      var b = cljs.core.nth.call(null, a, 0, null);
      return cljs.core.nth.call(null, a, 1, null) - b;
    };
  }(c, d), d), f = cljs.core.map.call(null, cljs.core.vector, e, cljs.core.cycle.call(null, melodicorn.music_theory.major_scale)), g = melodicorn.music_theory.apply_accidental.call(null, b, 0);
  return cljs.core.reductions.call(null, function(a, b, c, d, e) {
    return function(a, b) {
      var c = cljs.core.nth.call(null, b, 0, null);
      return cljs.core.nth.call(null, b, 1, null) - (c - a);
    };
  }(c, d, e, f, g), g, f);
};
melodicorn.music_theory.key_signature = function(a, b) {
  if (!cljs.core.truth_(b.call(null, melodicorn.music_theory.accidentals))) {
    throw Error("Assert failed: " + cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null, cljs.core.list(new cljs.core.Symbol(null, "accidental", "accidental", 325881907, null), new cljs.core.Symbol(null, "accidentals", "accidentals", -811257102, null)))));
  }
...
melodicorn.level_0.clef = function(a) {
  ...
  return(b = cljs.core._EQ_.call(null, b, new cljs.core.Keyword(null, "clef", "clef", 1016960572))) ? a.call(null, melodicorn.music_theory.clefs) : b;
};
melodicorn.level_0.bar_line = function(a) {
  a = cljs.core.nth.call(null, a, 0, null);
  return cljs.core._EQ_.call(null, a, new cljs.core.Keyword(null, "bar-line", "bar-line", 3507739872));
};
melodicorn.level_0.double_bar_line = function(a) {
  a = cljs.core.nth.call(null, a, 0, null);
  return cljs.core._EQ_.call(null, a, new cljs.core.Keyword(null, "double-bar-line", "double-bar-line", 4552105820));
};
melodicorn.level_0.note = function(a) {
  ...
  a = cljs.core.nth.call(null, a, 5, null);
  return(b = cljs.core._EQ_.call(null, b, new cljs.core.Keyword(null, "note", "note", 1017291620))) ? (c = melodicorn.music_theory.accidentals.call(null, c), cljs.core.truth_(c) ? (d = melodicorn.music_theory.accidentals.call(null, d), cljs.core.truth_(d) ? cljs.core.integer_QMARK_.call(null, e) && cljs.core.integer_QMARK_.call(null, f) && 0 < f && cljs.core.integer_QMARK_.call(null, a) && 0 < a : d) : c) : b;
};
melodicorn.level_0.key_signature = function(a) {
  ...
  return(b = cljs.core._EQ_.call(null, b, new cljs.core.Keyword(null, "key-signature", "key-signature", 2269635132))) ? (c = melodicorn.music_theory.diatonic_pitch_classes.call(null, c), cljs.core.truth_(c) ? (d = melodicorn.music_theory.accidentals.call(null, d), cljs.core.truth_(d) ? melodicorn.music_theory.modes.call(null, a) : d) : c) : b;
};
melodicorn.level_0.enitity_validation_dispatch = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null, "clef", "clef", 1016960572), melodicorn.level_0.clef, new cljs.core.Keyword(null, "key-signature", "key-signature", 2269635132), melodicorn.level_0.key_signature, new cljs.core.Keyword(null, "note", "note", 1017291620), melodicorn.level_0.note, new cljs.core.Keyword(null, "bar-line", "bar-line", 3507739872), melodicorn.level_0.bar_line, new cljs.core.Keyword(null, "double-bar-line", 
"double-bar-line", 4552105820), melodicorn.level_0.double_bar_line], null);
melodicorn.level_0.validate_entity = function(a) {
  var b = cljs.core.first.call(null, a);
  if (cljs.core.truth_(b)) {
    var c = melodicorn.level_0.enitity_validation_dispatch.call(null, b);
    return cljs.core.truth_(c) ? (a = c.call(null, a), cljs.core.truth_(a) ? null : b) : new cljs.core.Keyword(null, "entity-not-recognised", "entity-not-recognised", 3192248613);
  }
  return new cljs.core.Keyword(null, "no-entity-type", "no-entity-type", 1483357258);
};
melodicorn.level_0.validate_entities = function(a) {
  return cljs.core.remove.call(null, cljs.core.nil_QMARK_, cljs.core.map.call(null, melodicorn.level_0.validate_entity, a));
};
melodicorn.level_0.clef_before_first_note = function(a) {
  a = cljs.core.reductions.call(null, function(a, c) {
    var d = cljs.core.nth.call(null, a, 0, null), e = cljs.core.nth.call(null, a, 1, null);
    return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.truth_(d) ? d : cljs.core._EQ_.call(null, cljs.core.first.call(null, c), new cljs.core.Keyword(null, "note", "note", 1017291620)), cljs.core.truth_(e) ? e : cljs.core._EQ_.call(null, cljs.core.first.call(null, c), new cljs.core.Keyword(null, "clef", "clef", 1016960572))], null);
  }, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [!1, !1], null), a);
  a = cljs.core.some.call(null, cljs.core.PersistentHashSet.fromArray([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [!0, !1], null)], !0), a);
  return cljs.core.truth_(a) ? new cljs.core.Keyword(null, "note-before-clef", "note-before-clef", 2812261999) : null;
};
melodicorn.level_0.key_signature_before_first_note = function(a) {
  a = cljs.core.reductions.call(null, function(a, c) {
    var d = cljs.core.nth.call(null, a, 0, null), e = cljs.core.nth.call(null, a, 1, null);
    return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.truth_(d) ? d : cljs.core._EQ_.call(null, cljs.core.first.call(null, c), new cljs.core.Keyword(null, "note", "note", 1017291620)), cljs.core.truth_(e) ? e : cljs.core._EQ_.call(null, cljs.core.first.call(null, c), new cljs.core.Keyword(null, "clef", "clef", 1016960572))], null);
  }, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [!1, !1], null), a);
  a = cljs.core.some.call(null, cljs.core.PersistentHashSet.fromArray([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [!0, !1], null)], !0), a);
  return cljs.core.truth_(a) ? new cljs.core.Keyword(null, "note-before-key-signature", "note-before-key-signature", 927681385) : null;
};
melodicorn.level_0.clef_before_key_signature = function(a) {
  a = cljs.core.reductions.call(null, function(a, c) {
    var d = cljs.core.nth.call(null, a, 0, null), e = cljs.core.nth.call(null, a, 1, null);
    return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.truth_(d) ? d : cljs.core._EQ_.call(null, cljs.core.first.call(null, c), new cljs.core.Keyword(null, "key-signature", "key-signature", 2269635132)), cljs.core.truth_(e) ? e : cljs.core._EQ_.call(null, cljs.core.first.call(null, c), new cljs.core.Keyword(null, "clef", "clef", 1016960572))], null);
  }, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [!1, !1], null), a);
  a = cljs.core.some.call(null, cljs.core.PersistentHashSet.fromArray([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [!0, !1], null)], !0), a);
  return cljs.core.truth_(a) ? new cljs.core.Keyword(null, "key-signature-before-clef", "key-signature-before-clef", 4779766087) : null;
};
melodicorn.level_0.rules = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [melodicorn.level_0.clef_before_first_note, melodicorn.level_0.key_signature_before_first_note, melodicorn.level_0.clef_before_key_signature], null);
melodicorn.level_0.validate_0 = function(a) {
  return cljs.core.vec.call(null, cljs.core.remove.call(null, cljs.core.nil_QMARK_, cljs.core.map.call(null, function(b) {
    return b.call(null, a);
  }, melodicorn.level_0.rules)));
};
melodicorn.level_0_1 = {};
...
melodicorn.level_0_1.handle_0_key_signature = function(a, b) {
  cljs.core.nth.call(null, a, 0, null);
  var c = cljs.core.nth.call(null, a, 1, null), d = cljs.core.nth.call(null, a, 2, null);
...
melodicorn.level_0_1.handle_0_double_bar = function(a, b) {
  return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "double-bar-line", "double-bar-line", 4552105820), (new cljs.core.Keyword(null, "x", "x", 1013904362)).cljs$core$IFn$_invoke$arity$1(b), 0], null), melodicorn.util.acc_apply.call(null, b, new cljs.core.Keyword(null, "x", "x", 1013904362), melodicorn.util.inc_2)], null);
};
melodicorn.level_0_1.dispatch_0_1 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null, "key-signature", "key-signature", 2269635132), melodicorn.level_0_1.handle_0_key_signature, new cljs.core.Keyword(null, "clef", "clef", 1016960572), melodicorn.level_0_1.handle_0_clef, new cljs.core.Keyword(null, "note", "note", 1017291620), melodicorn.level_0_1.handle_0_note, new cljs.core.Keyword(null, "bar-line", "bar-line", 3507739872), melodicorn.level_0_1.handle_0_bar, new cljs.core.Keyword(null, 
"double-bar-line", "double-bar-line", 4552105820), melodicorn.level_0_1.handle_0_double_bar], null);
melodicorn.level_0_1.translate_0_1_f = function(a, b) {
  var c = cljs.core.get.call(null, melodicorn.level_0_1.dispatch_0_1, cljs.core.first.call(null, a)), c = cljs.core.truth_(c) ? c.call(null, a, b) : null;
  return cljs.core.truth_(c) ? c : new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null, b], null);
};
melodicorn.level_0_1.translate_0_1 = function(a) {
  return melodicorn.util.map_with_accumulator.call(null, melodicorn.level_0_1.translate_0_1_f, melodicorn.level_0_1.initial_translate_0_1_accumulator, a);
};
melodicorn.level_1_2 = {};
melodicorn.level_1_2.translate_1_2 = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "page-width", "page-width", 1215639674)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "page-height", "page-height", 2539740567)), f = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "margin-left", "margin-left", 1954909240)), g = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "margin-right", "margin-right", 
  4420916399)), h = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "margin-top", "margin-top", 2983929896)), k = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "margin-bottom", "margin-bottom", 3099939484)), c = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "trace-margins", "trace-margins", 2475746159)), g = d - f - g, k = e - h - k, d = cljs.core.truth_(c) ? new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 
  5, [new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "trace-box", "trace-box", 1737010357), new cljs.core.Keyword(null, "x", "x", 1013904362), f, new cljs.core.Keyword(null, "y", "y", 1013904363), h, new cljs.core.Keyword(null, "width", "width", 1127031096), g, new cljs.core.Keyword(null, "height", "height", 4087841945), k], null), new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "trace-box", 
  "trace-box", 1737010357), new cljs.core.Keyword(null, "x", "x", 1013904362), 1, new cljs.core.Keyword(null, "y", "y", 1013904363), 1, new cljs.core.Keyword(null, "width", "width", 1127031096), d - 1, new cljs.core.Keyword(null, "height", "height", 4087841945), e - 1], null)], null) : null, f = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, 
  "system", "system", 4421543329), new cljs.core.Keyword(null, "x", "x", 1013904362), f, new cljs.core.Keyword(null, "y", "y", 1013904363), h, new cljs.core.Keyword(null, "content", "content", 1965434859), a], null)], null);
  return cljs.core.concat.call(null, d, f);
};
melodicorn.canvas = {};
...
melodicorn.canvas.draw_3_canvas = function(a, b) {
  for (var c = cljs.core.seq.call(null, cljs.core.map.call(null, cljs.core.partial.call(null, melodicorn.canvas.draw_3_glyph, a), b)), d = null, e = 0, f = 0;;) {
    if (f < e) {
      cljs.core._nth.call(null, d, f), f += 1;
    } else {
      if (c = cljs.core.seq.call(null, c)) {
        d = c, cljs.core.chunked_seq_QMARK_.call(null, d) ? (c = cljs.core.chunk_first.call(null, d), f = cljs.core.chunk_rest.call(null, d), d = c, e = cljs.core.count.call(null, c), c = f) : (cljs.core.first.call(null, d), c = cljs.core.next.call(null, d), d = null, e = 0), f = 0;
      } else {
        return null;
      }
    }
...
melodicorn.level_2_3.render_2_bar_line = function(a, b) {
  ...
  return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "bar-line", "bar-line", 3507739872), c * e, d], null)], null);
};
melodicorn.level_2_3.render_2_double_bar_line = function(a, b) {
  var c = cljs.core.nth.call(null, a, 0, null), d = cljs.core.nth.call(null, a, 1, null), e = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, e = cljs.core.get.call(null, e, new cljs.core.Keyword(null, "note-head-width", "note-head-width", 656985030));
...
melodicorn.level_2_3.translate_entity = function(a, b, c) {
  var d = cljs.core.nth.call(null, c, 0, null), e = cljs.core.nth.call(null, c, 1, null), f = cljs.core.nth.call(null, c, 2, null);
  c = cljs.core.nthnext.call(null, c, 3);
  return cljs.core.concat.call(null, new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [d, a + e, b + f], null), c);
};
...
melodicorn.level_2_3.handle_2_trace_box = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, d = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "x", "x", 1013904362)), e = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "y", "y", 1013904363)), f = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "width", "width", 1127031096)), c = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "height", "height", 4087841945));
...
melodicorn.level_2_3.translate_2_3_f = function(a, b) {
  var c = (new cljs.core.Keyword(null, "type", "type", 1017479852)).cljs$core$IFn$_invoke$arity$1(a), d = cljs.core.get.call(null, melodicorn.level_2_3.translate_2_3_f_dispatch, c).call(null, a, b), c = cljs.core.nth.call(null, d, 0, null), d = cljs.core.nth.call(null, d, 1, null);
  return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c, d], null);
};
melodicorn.level_2_3.translate_2_3 = function(a, b) {
  var c = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null, "x", "x", 1013904362), 0, new cljs.core.Keyword(null, "y", "y", 1013904363), 0, new cljs.core.Keyword(null, "layout-params", "layout-params", 4167588091), b], null);
...
melodicorn.demo = {};
melodicorn.demo.example_level_0 = new cljs.core.PersistentVector(null, 21, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "clef", "clef", 1016960572), new cljs.core.Keyword(null, "bass", "bass", 1016920657)], null), new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "note", "note", 1017291620), 0, new cljs.core.Keyword(null, "no-accidental", 
...
"no-accidental", "no-accidental", 2955605368), 0, 1, 4], null), new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "bar-line", "bar-line", 3507739872)], null), new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "note", "note", 1017291620), 0, new cljs.core.Keyword(null, "no-accidental", "no-accidental", 2955605368), 1, 1, 4], null), new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, 
[new cljs.core.Keyword(null, "note", "note", 1017291620), 4, new cljs.core.Keyword(null, "no-accidental", "no-accidental", 2955605368), 0, 1, 4], null), new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "note", "note", 1017291620), 2, new cljs.core.Keyword(null, "no-accidental", "no-accidental", 2955605368), 0, 1, 4], null), new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "bar-line", 
"bar-line", 3507739872)], null), new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "clef", "clef", 1016960572), new cljs.core.Keyword(null, "bass", "bass", 1016920657)], null), new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "note", "note", 1017291620), 0, new cljs.core.Keyword(null, "no-accidental", "no-accidental", 2955605368), 0, 1, 4], null), new cljs.core.PersistentVector(null, 
6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "note", "note", 1017291620), 4, new cljs.core.Keyword(null, "no-accidental", "no-accidental", 2955605368), -1, 1, 4], null), new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "note", "note", 1017291620), 2, new cljs.core.Keyword(null, "no-accidental", "no-accidental", 2955605368), -1, 1, 4], null), new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, 
[new cljs.core.Keyword(null, "bar-line", "bar-line", 3507739872)], null), new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "note", "note", 1017291620), 0, new cljs.core.Keyword(null, "no-accidental", "no-accidental", 2955605368), -1, 1, 4], null), new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "double-bar-line", "double-bar-line", 4552105820)], null)], null);
...
new cljs.core.Keyword(null, "note-head-height", "note-head-height", 2401315787), new cljs.core.Keyword(null, "note-head-width", "note-head-width", 656985030), new cljs.core.Keyword(null, "trace-margins", "trace-margins", 2475746159)], [250, 15, 10, 50, 1E3, 10, 15, 20, !0]);
var errors_5101 = melodicorn.level_0.validate_0.call(null, melodicorn.demo.example_level_0), ok_5102 = cljs.core._EQ_.call(null, 0, cljs.core.count.call(null, errors_5101));
if (ok_5102) {
  var canvas_5103 = goog.dom.getElement("the-canvas"), graphics_context_5104 = canvas_5103.getContext("2d"), layer_1_5105 = melodicorn.level_0_1.translate_0_1.call(null, melodicorn.demo.example_level_0), layer_2_5106 = melodicorn.level_1_2.translate_1_2.call(null, layer_1_5105, melodicorn.demo.layout_parameters), layer_3_5107 = melodicorn.level_2_3.translate_2_3.call(null, layer_2_5106, melodicorn.demo.layout_parameters);
  console.log("Render 0 to 1:", "" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(layer_1_5105));
  console.log("Render 1 to 2:", "" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(layer_2_5106));
  console.log("Render 2 to 3:", "" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(layer_3_5107));
  melodicorn.canvas.draw_3_canvas.call(null, graphics_context_5104, layer_3_5107);
} else {
  console.log("Errors:", "" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(errors_5101));
}
;